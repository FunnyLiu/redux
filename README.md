...
- [redux-saga](https://github.com/FunnyLiu/redux-saga/tree/readsource) - redux强力中间件，基于generator提供一整体异步解决方案
- [dva](https://github.com/FunnyLiu/dva/tree/readsource) - dva 通过 model 的概念把一个领域的模型管理起来，包含同步更新 state 的 reducers，处理异步逻辑的 effects，订阅数据源的 subscriptions
